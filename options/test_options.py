...
class TestOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--phase', type=str, default='mytest', help='train, val, test, etc')
        ...
        self.parser.add_argument('--how_many', type=int, default=2000, help='how many mytest images to run')
